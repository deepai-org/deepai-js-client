"use strict";
import { baseUrl as apiBaseUrl } from "./apiBaseUrl";
var WAD_COLORS = [
  "rgb(173, 35, 35)", // Red
  "rgb(42, 75, 215)", // Blue
...
export async function renderResultIntoElement(result, element) {
...
export function renderAnnotatedResultIntoElement(annotatedResult, element) {
