...
var apiBaseUrl = (__webpack_require__(4732).baseUrl);

var resultRendering = __webpack_require__(2244);

var isBrowserEnv = typeof window !== 'undefined';
var globalObject = isBrowserEnv ? window : global;
var formData;
...
if (typeof window !== 'undefined' && window.FormData) {
  ...
  try {
    formData = __webpack_require__(6882);
  } catch (error) {
...
var DeepAI = __webpack_require__(2297); // Create the default instance to be exported
...
//# sourceMappingURL=deepai.node.map