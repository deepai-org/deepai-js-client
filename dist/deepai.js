...
// EXTERNAL MODULE: ./lib/core/apiBaseUrl.js
var apiBaseUrl = __webpack_require__(732);
;// CONCATENATED MODULE: ./lib/core/resultRendering.js
...
function prependApiBaseIfNeeded(url) {
  if (isAbsolute.test(url) || isDataOrBlob.test(url)) {
    ...
    return apiBaseUrl.baseUrl + url; // turn relative into absolute
  }
}
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.next = 5;
            return fetch(apiBaseUrl.baseUrl + "/get_standard_api_result_data/" + result.id, {
              credentials: "include"
            });
...
;// CONCATENATED MODULE: ./lib/core/DeepAI.js


function DeepAI_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function DeepAI_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { DeepAI_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { DeepAI_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
function urlForModel(model_name) {
  return apiBaseUrl.baseUrl + "/api/" + model_name;
}

DeepAI.prototype.callStandardApi = /*#__PURE__*/function () {
  var _request = DeepAI_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(model_name, inputs_object) {
...
DeepAI.prototype.renderResultIntoElement = renderResultIntoElement;
DeepAI.prototype.renderAnnotatedResultIntoElement = renderAnnotatedResultIntoElement;
;// CONCATENATED MODULE: ./lib/deepai.js


 // Create the default instance to be exported

var deepai = new DeepAI();
/* harmony default export */ const lib_deepai = (deepai);
